...
2. [Create](https://github.com/gmch1/TapBind/releases/new) a new _draft_ release, setting its tag and title to the new `MARKETING_VERSION`. Click "Save draft", don't publish.
3. Run the ["Build, Sign and Upload TapBind"](https://github.com/gmch1/TapBind/actions/workflows/build-to-release.yml) workflow.
...
- The release should have a `TapBind.zip` asset as a result of the workflow run.
